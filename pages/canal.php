...
<body>
    ...
    <?php if (isset($_SESSION['isAdminLoggedIn']) && $_SESSION['isAdminLoggedIn'] === true) : ?>
        ...
        <div class="split-screen">
            ...
            <div class="blocks">
                <div class="block">
                    <img width="200px" height="150px" src="data:image/jpeg;base64,<?= base64_encode($product[0][3]) ?>" alt="Изображение">
                    <p><?= $product[0][1] ?></p>
                    <a href="rehau.php">
                ...
                <div class="block">
                    <img width="200px" height="150px" src="data:image/jpeg;base64,<?= base64_encode($product[1][3]) ?>" alt="Изображение">
                    <p><?= $product[1][1] ?></p>
                    <a href="rehau.php">
                        <p><?= $manufacturer['name'] ?></p>
                    </a>
                ...
                <div class="block">
                    <img width="200px" height="150px" src="data:image/jpeg;base64,<?= base64_encode($product[2][3]) ?>" alt="Изображение">
                    <p><?= $product[2][1] ?></p>
                    <a href="rehau.php">
                        <p><?= $manufacturer['name'] ?></p>
                    </a>
