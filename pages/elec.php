...
<body>
    ...
    <?php if (isset($_SESSION['isAdminLoggedIn']) && $_SESSION['isAdminLoggedIn'] === true) : ?>
        ...
        <div class="split-screen">
            <div class="admin-panel">
                ...
                <table class="">
                    ...
                    <?php
                    $sql = "SELECT products.product_id, products.name, products.price, products.manufacture_id AS manufacture_id 
                    FROM products
                    LEFT JOIN manufactures ON manufactures.name=products.manufacture_id";
        ...
        <div class="blocks">
            <div class="block">
                <img width="200px" height="150px" src="data:image/jpeg;base64,<?= base64_encode($product[3][3]) ?>" alt="Изображение">
                <p><?= $product[3][1] ?></p>
                <a href="rehau.php">
            ...
            <div class="block">
                <img width="200px" height="150px" src="data:image/jpeg;base64,<?= base64_encode($product[4][3]) ?>" alt="Изображение">
                <p><?= $product[4][1] ?></p>
                <a href="rehau.php">
                    <p><?= $manufacturer['name'] ?></p>
                </a>
            ...
            <div class="block">
                <img width="200px" height="150px" src="data:image/jpeg;base64,<?= base64_encode($product[5][3]) ?>" alt="Изображение">
                <p><?= $product[5][1] ?></p>
                <a href="rehau.php">
                    <p><?= $manufacturer['name'] ?></p>
                </a>
