...
<body>
    ...
    <?php if (isset($_SESSION['isAdminLoggedIn']) && $_SESSION['isAdminLoggedIn'] === true) : ?>
        ...
        <div class="split-screen">
            ...
            <div class="blocks">
                <div class="block">
                    <img width="200px" height="150px" src="data:image/jpeg;base64,<?= base64_encode($product[9][3]) ?>" alt="Изображение">
                    <p><?= $product[9][1] ?></p>
                    <a href="rehau.php">
                ...
                <div class="block">
                    <img width="200px" height="150px" src="data:image/jpeg;base64,<?= base64_encode($product[10][3]) ?>" alt="Изображение">
                    <p><?= $product[10][1] ?></p>
                    <a href="rehau.php">
                        <p><?= $manufacturer['name'] ?></p>
                    </a>
                    <p><?= $product[10][2] ?> лей</p>
                    <button><a href="basket.php">Оформить заказ</a></button>

                </div>
                <div class="block">
                    <img width="200px" height="150px" src="data:image/jpeg;base64,<?= base64_encode($product[11][3]) ?>" alt="Изображение">
                    <p><?= $product[11][1] ?></p>
                    <a href="rehau.php">
                        <p><?= $manufacturer['name'] ?></p>
                    </a>
                    <p><?= $product[11][2] ?> лей</p>
                    <button><a href="basket.php">Оформить заказ</a></button>
