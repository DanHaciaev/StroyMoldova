...
<body>
    ...
    <?php if (isset($_SESSION['isAdminLoggedIn']) && $_SESSION['isAdminLoggedIn'] === true) : ?>
        ...
        <div class="split-screen">
            ...
            <div class="blocks">
                <div class="block">
                    <img width="200px" height="150px" src="data:image/jpeg;base64,<?= base64_encode($product[6][3]) ?>" alt="Изображение">
                    <p><?= $product[6][1] ?></p>
                    <a href="rehau.php">
                ...
                <div class="block">
                    <img width="200px" height="150px" src="data:image/jpeg;base64,<?= base64_encode($product[7][3]) ?>" alt="Изображение">
                    <p><?= $product[7][1] ?></p>
                    <a href="rehau.php">
                        <p><?= $manufacturer['name'] ?></p>
                    </a>
                ...
                <div class="block">
                    <img width="200px" height="150px" src="data:image/jpeg;base64,<?= base64_encode($product[8][3]) ?>" alt="Изображение">
                    <p><?= $product[8][1] ?></p>
                    <a href="rehau.php">
                        <p><?= $manufacturer['name'] ?></p>
                    </a>
